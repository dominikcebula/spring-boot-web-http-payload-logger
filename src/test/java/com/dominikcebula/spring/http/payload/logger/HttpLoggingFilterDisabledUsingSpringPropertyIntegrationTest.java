...
@ActiveProfiles({"filter-logger-disabled-using-spring-property"})
public class HttpLoggingFilterDisabledUsingSpringPropertyIntegrationTest {
    @LocalServerPort
    private int port;
    ...
    @Test
    void shouldNotLogRequestOrResponseWhenLoggingFilterIsDisabledUsingSpringProperty() {
